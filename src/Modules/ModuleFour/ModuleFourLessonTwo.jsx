...
import reference from './ModuleFourReferences/lesson_two.json';
import quizQuestion from './ModuleFourQuizQuestions/lesson_two.json';
import transcript from "./ModuleFourTranscripts/lesson_two.json";
...
function ModuleFourLessonTwo() {
  ...
  return (
    ...
    >
      ...
      >
        Lesson 4.2: Infrastuctural Solutions
      </h1>
      <Box
        sx={{
          display: "flex",
      ...
      >
        <LessonComponent
          url="https://www.youtube.com/embed/5e0eG3fDNRg?si=Abvfca1IcHn66C8c"
          number="2"
...
export default ModuleFourLessonTwo;
