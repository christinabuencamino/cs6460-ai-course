...
import quizQuestion from "./ModuleOneQuizQuestions/lesson_two.json";
import transcript from "./ModuleOneTranscripts/lesson_two.json";
import reference from "./ModuleOneReferences/lesson_two.json";
...
function ModuleOneLessonTwo() {
  ...
  return (
    ...
    >
      ...
      >
        <LessonComponent
          url="https://www.youtube.com/embed/KKKec4-zL60?si=dndkMvRma3gzWOOQ"
          number="2"
...
export default ModuleOneLessonTwo;
