...
import reference from './ModuleThreeReferences/lesson_one.json';
import quizQuestion from './ModuleThreeQuizQuestions/lesson_one.json';
import transcript from "./ModuleThreeTranscripts/lesson_one.json";
...
function ModuleThreeLessonOne() {
  ...
  return (
    ...
    >
      ...
      >
        Lesson 3.1A: Informational Harm: Algorithmic Bias
      </h1>
      <Box
        sx={{
          display: "flex",
      ...
      >
        <LessonComponent
          url="https://www.youtube.com/embed/RQKQ-nic6JA?si=SpXD1ZsRFNOmXOi_"
          number="2"
...
export default ModuleThreeLessonOne;