...
import reference from './ModuleThreeReferences/lesson_two.json';
import quizQuestion from './ModuleThreeQuizQuestions/lesson_two.json';
import transcript from './ModuleThreeTranscripts/lesson_two.json';
...
function ModuleThreeLessonTwo() {
  ...
  return (
    ...
    >
      ...
      >
        Lesson 3.1B: Informational Harm: Feedback Loops & Hallucination
      </h1>
      <Box
        sx={{
          display: "flex",
      ...
      >
        <LessonComponent
          url="https://www.youtube.com/embed/i5GQGVWGzMo?si=ZPd5Opgwmj-CVDhP"
          number="2"
