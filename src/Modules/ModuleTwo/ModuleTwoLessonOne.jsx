...
import reference from './ModuleTwoReferences/lesson_one.json';
import quizQuestion from "./ModuleTwoQuizQuestions/lesson_one.json";
import transcript from "./ModuleTwoTranscripts/lesson_one.json";
...
function ModuleTwoLessonOne() {
  ...
  return (
    ...
    >
      ...
      >
        Lesson 2.1: Why do we trust GenAI?
      </h1>
      <Box
        sx={{
          display: "flex",
      ...
      >
        <LessonComponent
          url="https://www.youtube.com/embed/GsUX9zW-fQo?si=nR46P_B5WIxpAtYt"
          number="2"
...
export default ModuleTwoLessonOne;