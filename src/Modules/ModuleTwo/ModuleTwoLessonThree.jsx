...
import reference from './ModuleTwoReferences/lesson_three.json';
import quizQuestion from "./ModuleTwoQuizQuestions/lesson_three.json";
import transcript from "./ModuleTwoTranscripts/lesson_three.json";
...
function ModuleTwoLessonThree() {
  ...
  return (
    ...
    >
      ...
      >
        Lesson 2.3: Authoritative Trust
      </h1>
      <Box
        sx={{
          display: "flex",
      ...
      >
        <LessonComponent
          url="https://www.youtube.com/embed/_9A7HnQFvMg?si=enkJGjbz_t9o9lDz"
          number="2"
...
export default ModuleTwoLessonThree;